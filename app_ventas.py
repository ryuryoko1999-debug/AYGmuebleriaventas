...
# --- GESTIÓN DE ESTADO PARA VISTA DETALLADA ---
        ...
        st.markdown(f"""
            <div style="background: white; padding: 20px; border-radius: 8px; border: 1px solid #ddd;">
                ...
                <div style="font-size: 18px; font-weight: bold; color: #00a650; margin-top:5px;">
                    {p['n_cuotas']} cuotas de $ {p['valor_cuota']:,.2f}
                </div>
                <div style="font-size: 12px; color: #666; margin-top:3px;">Total financiado: $ {p['p_fin']:,.2f}</div>
            </div>
        """, unsafe_allow_html=True)
